                    ...
                    <div id="profile" class="tab-pane  active">
                        <form class="sui-form">
                            <div class="input-prepend"><span class="add-on loginname"></span>
                                <input id="prependedInput" type="text" name="user_plone" placeholder="邮箱/用户名/手机号" class="span2 input-xfat">
                            </div>
                            ...
                            <div class="logined">
                                <input type="button" id="login" class="sui-btn btn-block btn-xlarge btn-danger" value="登录">
                            </div>
                        </form>
...
<script>
    $("#login").click(function () {
        ...
        // console.log(user_plone);
        var user_pwd = $('input[name="user_pwd"]').val();
        $.post('/logindo',{'user_plone':user_plone,'user_pwd':user_pwd},function (res) {
            if(res.code=='00001'){
                alert(res.msg);
            }
            if(res.code=='00002'){
