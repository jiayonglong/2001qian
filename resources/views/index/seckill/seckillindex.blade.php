...
<script type="text/javascript" src="satic/js/plugins/jquery/jquery.min.js"></script>
		...
		<div class="goods-list">
			...
			@foreach($jyl as $k=>$v)
				<li class="seckill-item">
					...
					<div class='price'><b class='sec-price'>￥{{$v->goods_qprice}}</b><b class='ever-price'>￥{{$v->goods_price}}</b></div>
					<div class='num'>
						<div>已售87%</div>
						<div class='progress'>
					...
					<a class='sui-btn btn-block btn-buy' href='/miao/{{$v->goods_id}}' target='_blank'>立即抢购</a>
				</li>
	   	@endforeach
			</ul>
		</div>
