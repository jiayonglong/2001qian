...
<script type="text/javascript">
		...
		<script>
			...
			setInterval(function () {
				...
				if($day>0){
					$('.overtime').html('距离结束:'+day + "天" + hour + "小时" + minute + "分钟" + seconds + "秒");
				}else{
					$('.overtime').html('距离结束:'+ hour + "小时" + minute + "分钟" + seconds + "秒");
				}
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="{{$v['goods_img']}}"  src="{{$v['goods_img']}}" width="410px" /></span>
						</div>
						@endforeach
						<!--下方的缩略图-->
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<button  target="_blank" class="sui-btn  btn-danger addshopcar">立即抢购</button>
									</li>
								</ul>
							</div>
						</div>
...
$('.sui-btn').click(function(){
	// alert(111);
	$.get('/confrimorder',{seckill_id:seckill_id},function(res){
		dd(seckill_id);
			},'json')
	})
